...
# DirectGUI shop/inventory removed — keep file focused on the dice simulator
import random
import math
...
# `globalClock` is sometimes exported differently depending on the Panda3D build.
# Prefer importing it from `panda3d.core`, but fall back to ShowBaseGlobal when
# necessary to avoid ImportError at import-time.
try:
...
# --- LIBRARY CHECK ---
# ShopInventoryUI intentionally removed per user request
try:
    import simplepbr
    import gltf
except ImportError:
